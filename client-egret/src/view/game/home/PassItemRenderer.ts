class PassItemRenderer extends eui.ItemRenderer {
    public constructor(){
        super();
        this.skinName = "PassItemRendererSkin";
    }

    public clickBtn:PassClickBtn;

    protected dataChanged():void{
        var index:number = (this.data.id+4)%10;
        ...
        if(this.data.id%5 === 1 && this.data.id !== 1){
            var bossId:number = (this.data.id-1)/5;
            var boss:PassMonster = PassMonster.Boss[bossId-1];
            this.addChild(boss);
